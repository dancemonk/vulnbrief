...
VulnBrief is currently a documentation scaffold. The repository does not yet
contain an installable package, CLI, database, or test suite. GitHub Issues
...
Installation and CLI examples will be added after the Python package is
bootstrapped. No project lint, type-check, test, or full verification command
exists yet. For documentation-only changes, use:
...
Application and test directories will be added by their governing GitHub
Issues.

## Known Limitations

- No application code or executable CLI exists.
